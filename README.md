...
I'm a **backend engineer** who builds **AI systems** — production APIs, retrieval pipelines, and explainable healthcare intelligence — where architecture matters more than prompts, and systems matter more than demos.
...
`Python` `FastAPI` `React` `LangGraph` `Neo4j` `XGBoost` `Docker`

## Stack

- **Languages** — `Python` `C++` `C` `Java`

- **Backend & Systems** — `FastAPI` `Flask` `Docker` `Neo4j` `MariaDB` `MongoDB` `MySQL` `Azure` `Linux` `Git`

- **AI & ML** — `RAG` `CAG` `LangChain` `LangGraph` `XGBoost` `Groq` `Gemini`
...
- **Event Head**, Tech Habba '25 - 2000+ participants, 150+ volunteers

## Now

Building AI systems that bridge retrieval, agents, and production infrastructure — currently exploring neuromorphic computing and next-gen agent architectures.



**Computer Science Undergrad**, Acharya Institute of Technology · 2027 · CGPA 8.4/10

&nbsp;

<div align="center">

[![LeetCode Stats](https://leetcard.jacoblin.cool/inwrongplannet?ext=heatmap&border=0&font=JetBrains%20Mono&colors=050505,0a0a0a,ededed,a1a1aa,00e599,00e599,58a6ff,00e599)](https://leetcode.com/u/inwrongplannet/)
